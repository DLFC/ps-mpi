...
const int PBNode::kRankMpiFieldNumber;
#endif  // !_MSC_VER
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 5: {
        ...
        if (input->ExpectTag(48)) goto parse_rank_mpi;
        break;
      }

      // optional int32 rank_mpi = 6;
      case 6: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_VARINT) {
         parse_rank_mpi:
...
void PBNode::SerializeWithCachedSizes(
  ...
  // optional int32 rank_mpi = 6;
  if (has_rank_mpi()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(6, this->rank_mpi(), output);
  }
...
void PBNode::MergeFrom(const PBNode& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_rank_mpi()) {
      set_rank_mpi(from.rank_mpi());
    }
  }
}
...
void PBNode::Swap(PBNode* other) {
  if (other != this) {
    ...
    std::swap(rank_mpi_, other->rank_mpi_);
